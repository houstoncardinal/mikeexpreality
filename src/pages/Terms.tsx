...
import { getTermsSchemas } from "@/lib/schema";

const Terms = () => {
  const schemas = getTermsSchemas();
  
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | Legal Information | {siteConfig.name}</title>
        <meta 
          name="description" 
          content="Terms and Conditions for Mike Ogunkeye Real Estate. Fair Housing statement, TREC information, property disclaimers, and service terms for Houston real estate." 
        />
        <link rel="canonical" href={`${siteConfig.url}/terms`} />
        <meta name="robots" content="noindex, follow" />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Terms & Conditions | ${siteConfig.name}`} />
        <meta property="og:description" content="Terms and Conditions for Mike Ogunkeye Real Estate website and services." />
